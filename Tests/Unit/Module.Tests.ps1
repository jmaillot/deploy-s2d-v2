...
Describe 'Deploy-S2D module' {
    ...
    It 'keeps helpers private' {
        ...
        foreach ($h in @('Write-S2DLog', 'Select-S2DNic', 'Get-S2DPoolableDisk', 'Get-S2DPoolDisk', 'Get-S2DVolumeEfficiency', 'Get-S2DCapacityMedia', 'Get-S2DCapacityReserve', 'Get-S2DVolumeTierMap')) {
